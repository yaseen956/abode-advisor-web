...
const locations = ["Any", "Downtown", "Uptown", "Suburbs", "Rural"];
      ...
      <section className="bg-blue-500 text-white py-20">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl font-extrabold mb-4">
            Find Your Dream Home with AbodeAdvisor
          </h1>
          <p className="text-lg mb-8">
            Explore a wide range of properties and projects to find the perfect
          ...
          <div className="flex justify-center">
            <Input
              ...
              className="w-full md:w-auto rounded-full px-6 py-3 mr-4 text-gray-700"
            />
            <Button className="bg-white text-blue-600 hover:bg-blue-100 rounded-full">
              Search
            </Button>
          </div>
        </div>
